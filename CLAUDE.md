...
**Session 51: combustion thin-slice complete — agent/calculations/core/combustion.py (Surya Siddhanta orbs, retro overrides Me 14→12 / Ve 10→8) + 31 tests (4-chart hand-falsified parity, retro-override band); chart_calculator.py FLG_SPEED retrograde bug fixed (flag was always False since inception). 1821 passed, 3 skipped. Next: SESSION_LOG entry, then POST-CHECKPOINT items — ephemeris consolidation (helpers/ephemeris.py) vs Drik/Bhava-Drishti extraction ordering per Master Build Plan.**
