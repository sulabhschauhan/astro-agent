            ...
            messages=[
                {
                    ...
                    "content": (
                        ...
                        "  SLOPE: exactly one of {upward | downward | straight | not clearly visible}\n"
                        "RELATIONAL TARGETS: for HEAD LINE, HEART LINE, and FATE LINE, report the "
                        "four fields below. For ORIGIN and TERMINATION choose ONLY from that "
                        "line's closed menu shown inline (or 'none') — never a landmark outside "
                        "its menu. For PROXIMITY and BRANCHES_TO use the canonical-names list.\n"
                        "  Canonical names (PROXIMITY / BRANCHES_TO only): Line of Life, Line of "
                        "Head, Line of Heart, Line of Fate, Line of Sun; Mount of Jupiter, Mount "
                        "of Saturn, Mount of the Sun, Mount of Mercury, Upper Mount of Mars, Lower "
                        "Mount of Mars, Mount of Luna, Mount of Venus; Junction of First and "
                        "Second Fingers; Wrist, Percussion\n"
                        "  PROXIMITY format: \"<degree> to <landmark>\" where degree is exactly one "
                        "of {touching | medium | distant | n/a} and landmark is a canonical name "
                        "above or 'none'. Only report a real proximity relation this specific line "
                        "actually has; if none is doctrinally salient for it, answer 'n/a to none'.\n"
                        "  DIRECTION LAW (heart line only): the finger/mount end is ORIGIN and the "
                        "percussion is TERMINATION — even though common convention calls the "
                        "percussion the start. Follow this for the heart line's ORIGIN/TERMINATION.\n"
                        "HEAD LINE RELATIONAL:\n"
                        "  ORIGIN: <one of {Mount of Jupiter | Line of Life | Lower Mount of Mars} or 'none'>\n"
                        "  PROXIMITY: <degree> to <landmark or none>\n"
                        "  TERMINATION: <one of {Mount of Luna | Percussion | Upper Mount of Mars} or 'none' if the line is short and ends mid-palm>\n"
                        "  BRANCHES_TO: <landmark(s) any branch is directed toward, or 'none'>\n"
                        "HEART LINE RELATIONAL:\n"
                        "  ORIGIN: <one of {Mount of Jupiter | Junction of First and Second Fingers | Mount of Saturn} or 'none'>\n"
                        "  PROXIMITY: <degree> to <landmark or none>\n"
                        "  TERMINATION: <one of {Percussion | Mount of Mercury} or 'none'>\n"
                        "  BRANCHES_TO: <landmark(s) any branch is directed toward, or 'none'>\n"
                        "FATE LINE RELATIONAL:\n"
                        "  ORIGIN: <one of {Line of Life | Wrist | Mount of Luna | Line of Head | Line of Heart} or 'none'>\n"
                        "  PROXIMITY: <degree> to <landmark or none>\n"
                        "  TERMINATION: <one of {Mount of Saturn | Mount of Jupiter | Line of Heart | Line of Head} or 'none'>\n"
                        "  BRANCHES_TO: <landmark(s) any branch is directed toward, or 'none'>\n"
