            ...
            messages=[
                {
                    ...
                    "content": (
                        ...
                        "following four fields using ONLY these canonical names (else 'none'):\n"
                        "  Lines: Line of Life, Line of Head, Line of Heart, Line of Fate, Line of Sun\n"
                        "  Mounts: Mount of Jupiter, Mount of Saturn, Mount of the Sun, Mount of Mercury, "
                        "Mount of Mars, Mount of Luna, Mount of Venus\n"
                        "  Regions: Wrist, Percussion\n"
                        ...
                        "  ORIGIN: <landmark it rises from, or 'none' if independent>\n"
                        "  PROXIMITY: <degree> to <landmark or none>\n"
                        "  TERMINATION: <landmark it ends on/under, or 'none'>\n"
